...
void setup()
{
  ...
  while(digitalRead(buttonPin, LOW){digitalWrite(44, HIGH); delay(250); digitalWrite(44, LOW); delay(250);}
  digitalWrite(44, LOW);
  
  if(digitalRead(buttonPin, LOW) {digitalWrite(44, HIGH); delay(50); digitalWrite(44, LOW); delay(1000);}
...
{ 
  ...
  input = Serial.read();
  if(digitalRead(buttonPin, LOW) || input == "end"){digitalWrite(44, HIGH); delay(50); digitalWrite(44, LOW); delay(50);}
...
void inputs(){
  if (Serial.available()>0){
    input = Serial.read();
     ...
     else if (input == 'a'){ digitalWrite(44, HIGH); movimento('a'); digitalWrite(44, LOW); Serial.println("f");} // trasla sinistra (da definire)
     else if (input == 'd'){ digitalWrite(44, HIGH); movimento('d'); digitalWrite(44, LOW); Serial.println("f");} // trasla destra (da definire)
     
     else if (input == 'q'){ digitalWrite(44, HIGH); movimento('q'); digitalWrite(44, LOW); Serial.println("f");} // gira di 90 gradi stampa f alla fine
     else if (input == 'e'){ digitalWrite(44, HIGH); movimento('e'); digitalWrite(44, LOW); Serial.println("f");} // gira di 90 gradi stampa f alla fine 
     ...
     else if (input == 'p'){ digitalWrite(44, HIGH); prova(); digitalWrite(44, LOW); Serial.println("f");} // stampa la tettura dei sensori con f alla fine e all'inizio
...
void sensori()
{
  ...
  if(medie[0][0]<distanza && medie[0][1]<distanza){ //destra
    ...
    raspy[0][2]='1';
    raspy[2][2]='1';
  }if(medie[2][0]<distanza && medie[2][1]<distanza){ //davanti
    raspy[0][2]='1';
    raspy[0][0]='1';
  }if(medie[3][0]<distanza && medie[3][1]<distanza){ //indietro
    raspy[0][0]='1';
    raspy[2][0]='1';  
  }
