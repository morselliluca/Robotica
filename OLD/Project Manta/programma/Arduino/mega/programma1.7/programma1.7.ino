...
if(simulazione == false){
  ...
  if (Serial.available()>0){
    input = Serial.read();
     if (input == 'w')     { simavanti();         }
     else if (input == 'q'){ simsinistra();       }
     else if (input == 's'){ simindietro();       }
     else if (input == 'e'){ simdestra();         }
     Serial.println(campo[posy][posx])
  }
  
  }

}
void simavanti()  {if(posy<9){posy++;}}
void simindietro(){if(posy>0){posy--;}}
void simsinistra(){if(posx>0){posx--;}}
void simdestra()  {if(posx<9){posx++;}}
...
void sensori(){
  ...
  if(medie[0][0]<distanza && medie[0][1]<distanza){
    raspy[2][0]='1';
    raspy[2][2]='1';
  }if(medie[1][0]<distanza && medie[1][1]<distanza){
    raspy[0][2]='1';
    raspy[2][2]='1';
  }if(medie[2][0]<distanza && medie[2][1]<distanza){
    raspy[0][2]='1';
    raspy[0][0]='1';
  }if(medie[3][0]<distanza && medie[3][1]<distanza){
    raspy[0][0]='1';
    raspy[2][0]='1';  
  }
