...
/////////////////simulazione////////////////////
  ...
  if (Serial.available()>0){
    input = Serial.read();
     if (input == 'w')     { if(posy>0){posy--;} printsim();}
     else if (input == 'a'){ if(posx>0){posx--;} printsim();}
     else if (input == 's'){ if(posy<9){posy++;} printsim();}
     else if (input == 'd'){ if(posx<9){posx++;} printsim();}
    }
